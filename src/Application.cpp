...
void processInput(GLFWwindow* window, float& filter);
...
int main()
{
    ...
    /* Third(?), generate and apply our texture */
    ...
    unsigned char* data = stbi_load("C:/Users/wesat/Desktop/LearnOpenGL/Dependencies/img/container.jpg", &width, &height, &nrChannels, 0);
    if (data)
    {
    ...
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR_MIPMAP_LINEAR);
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
    data = stbi_load("C:/Users/wesat/Desktop/LearnOpenGL/Dependencies/img/awesomeface.png", &width, &height, &nrChannels, 0);
    if (data)
    {
